...
- The user hasn't identified options yet (use ToT to generate them)
- The problem has deep interdependencies (use GoT)
- There are more than 3 options to compare (use ToT)
...
## Context
[Brief situation summary and evaluation criteria]
